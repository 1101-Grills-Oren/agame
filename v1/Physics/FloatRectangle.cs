...
{
    private static FloatRectangle emptyRectangle;
    ...
    public static FloatRectangle Empty => emptyRectangle;
    ...
    //
    // Summary:
    //     A Microsoft.Xna.Framework.Vector2 located in the center of this Microsoft.Xna.Framework.Rectangle.
    //
    //
    // Remarks:
    ...
    public override bool Equals(object obj)
    {
        ...
        {
            return this == (FloatRectangle)obj;
        }
    ...
    public static void Intersect(ref FloatRectangle value1, ref FloatRectangle value2, out FloatRectangle result)
    {
        if (value1.Intersects(value2))
        {
            ...
            result = new FloatRectangle(num2, num3, num - num2, num4 - num3);
        }
        else
        {
